...
from projects.views import ProjectListCreateView, ProjectDetailView, ProjectMembersView, RemoveMemberView, EventListView
...
urlpatterns = [
    ...
    path("projects/<int:id>/events/", EventListView.as_view(), name="project-events"),
]